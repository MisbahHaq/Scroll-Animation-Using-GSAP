...
"C:\\Users\\Misbah\\AppData\\Local\\Android\\sdk\\cmake\\3.22.1\\bin\\cmake.exe" ^
  ...
  "-DCMAKE_LIBRARY_OUTPUT_DIRECTORY=D:\\Text to Image\\img\\img\\build\\app\\intermediates\\cxx\\RelWithDebInfo\\58233f68\\obj\\armeabi-v7a" ^
  "-DCMAKE_RUNTIME_OUTPUT_DIRECTORY=D:\\Text to Image\\img\\img\\build\\app\\intermediates\\cxx\\RelWithDebInfo\\58233f68\\obj\\armeabi-v7a" ^
  "-DCMAKE_BUILD_TYPE=RelWithDebInfo" ^
  "-BD:\\Text to Image\\img\\img\\android\\app\\.cxx\\RelWithDebInfo\\58233f68\\armeabi-v7a" ^
  -GNinja ^
  -Wno-dev ^
  --no-warn-unused-cli
